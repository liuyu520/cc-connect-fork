...
const (
	...
	// Project router messages (multi-project shared platform)
	MsgProjectSelect   MsgKey = "project.select"
	MsgProjectCurrent  MsgKey = "project.current"
	MsgProjectSwitched MsgKey = "project.switched"
	MsgProjectInvalid  MsgKey = "project.invalid"
	MsgProjectList     MsgKey = "project.list"
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgBuiltinCmdResume: {
		LangEnglish:            "Resume a session: no arg = list, arg = switch, arg: [number|id|name]",
		LangChinese:            "恢复会话：无参数显示列表，有参数切换会话，参数: [序号|ID|名称]",
		LangTraditionalChinese: "恢復會話：無參數顯示列表，有參數切換會話，參數: [序號|ID|名稱]",
		LangJapanese:           "セッション復元：引数なし=一覧、引数あり=切替、引数: [番号|ID|名前]",
		LangSpanish:            "Reanudar sesión: sin arg = listar, con arg = cambiar, arg: [número|id|nombre]",
	},
	MsgBuiltinCmdSearch: {
	...
	// Project router messages
	MsgProjectSelect: {
		LangEnglish:            "Please select a project:",
		LangChinese:            "请选择要操作的项目：",
		LangTraditionalChinese: "請選擇要操作的專案：",
		LangJapanese:           "プロジェクトを選択してください：",
		LangSpanish:            "Por favor seleccione un proyecto:",
	},
	MsgProjectCurrent: {
	...
	MsgProjectSwitched: {
		...
		LangJapanese:           "プロジェクトを切り替えました: **%s**",
		LangSpanish:            "Cambiado al proyecto: **%s**",
	},
	MsgProjectInvalid: {
		LangEnglish:            "Invalid selection, please try again.",
		LangChinese:            "无效选择，请重试。",
		LangTraditionalChinese: "無效選擇，請重試。",
		LangJapanese:           "無効な選択です。もう一度お試しください。",
		LangSpanish:            "Selección no válida, por favor intente de nuevo.",
	},
	MsgProjectList: {
	...
	MsgProjectHelp: {
		LangEnglish:            "`/project [name]` — switch project",
		LangChinese:            "`/project [名称]` — 切换项目",
		LangTraditionalChinese: "`/project [名稱]` — 切換專案",
		LangJapanese:           "`/project [名前]` — プロジェクト切替",
		LangSpanish:            "`/project [nombre]` — cambiar proyecto",
	},
	MsgPatrolIdle: {
		LangEnglish:            "I'm idle now. Is there anything I can help with?",
		LangChinese:            "我在空闲中，有什么需要帮助的吗？",
